...
fUnfolded_bayes="unfolding/results_pp/output_default/bayes_default_2698.root"
fUnfolded_svd="unfolding/results_pp/output_default/svd_default_2698.root"

# Unfolded input files, pPb binning
fUnfolded_bayes_pPbBinning="unfolding/results_pp/output_default/bayes_pPbBinning_2698.root"
...
for (( r=2; r<=5; r++ ))
do
#    root -x -q -l -b 'plotSystematicsCorrelated.cxx("'$fUnfolded_bayes'","'$uType'",'$r',"'$filetype'","'$outputdir'","'$dSysRootFiles'","'$inputtxtfiles'")'
#    if [ $r -ne 2 ]
#    then
#        root -x -q -l -b 'plotRatioSystematicsCorrelated.cxx("'$fUnfolded_bayes'","'$uType'",'$r',"'$filetype'","'$outputdir'","'$dSysRootFiles'","'$inputtxtfiles'")'
#    fi
...
#root -x -q -l -b 'plotFinalSpectrum.cxx("'$fUnfolded_bayes'","'$fPYTHIA'","'$fPOWHEG'","'$dSysRootFiles'","'$uType'","'$outputdir'","'$filetype'")'
