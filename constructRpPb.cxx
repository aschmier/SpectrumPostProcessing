...
void constructRpPb(TString ppRootFile, TString pPbRootFile, TString output, TString fileType, int minradius = 2, int maxradius = 4)
{
    ...
    gSystem->Exec("mkdir -p "+output+"/RpPb");
