...
rundir="/home/austin/alice/data/pp8TeV_MC/mergedGA_LHC16c2/LHC16c2_default/runwise"
...
jesfile="/home/austin/alice/unfoldingResults/EnergyScale/EnergyScaleResults.root"
jettype="Full"
filetype="pdf"

[ -d $out ] || mkdir $out

root -x -q -l -b '/home/austin/alice/SubstructureAnalysis/EnergyScale/EnergyScaleTask/extractJetEnergyScaleSimple.cpp("'$mcfile'","'$jettype'Jet","nodownscalecorr")'
